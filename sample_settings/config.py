...
SECRET_KEY = '[Random String Here]'  # used internally by flask
SALT = '[Random String Here]'  # used for hashing passwords and API keys
MESSAGE_TOKEN_SALT = '[Random String Here]'  # used for generating tokens for MQTT authentication
